...
class MainWindow(QuickSaleMixin, QMainWindow):       # mixin *first* in MRO
    ...
    def __init__(self):
        ...
        # Flags required by QuickSaleMixin
        ...
        split = QSplitter(Qt.Horizontal); split.addWidget(self.sent_log); split.addWidget(self.recv_log)
        ...
        box = QVBoxLayout(); box.addWidget(QLabel("<b>Free-Call XML Sandbox</b>"))
        self.free_xml_edit = QTextEdit(); box.addWidget(self.free_xml_edit, stretch=1)
        bar = QHBoxLayout()
        ...
        for fg, cmd, label in [
            ...
            b = QPushButton(label); b.setEnabled(bool(self.mac_key))
