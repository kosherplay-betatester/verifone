...
class VerifoneApp(QMainWindow):
    """GUI for Verifone P400: terminal control with custom commands and help dialog."""
    ...
    def __init__(self):
        ...
        ex_layout.addWidget(QLabel("KTK (16):"))
        ...
        mac_layout.addWidget(QLabel("MAC Key:"))
        ...
        logs_split.addWidget(self.sent_log)
        logs_split.addWidget(self.recv_log)
    ...
    def show_help(self):
        ...
        dlg = QDialog(self)
        dlg.setWindowTitle("Available Commands")
